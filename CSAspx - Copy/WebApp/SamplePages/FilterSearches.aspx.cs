...
namespace WebApp.SamplePages
{
    public partial class FilterSearches : System.Web.UI.Page
    {
        ...
        {
            //This method switches the user btw views on the form

            //The value assoicated with the menu item is treated as an index
            int index = Int32.Parse(e.Item.Value);

            //Active view index determines which view is displayed
