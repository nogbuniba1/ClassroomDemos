...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Supplier" SortExpression="SupplierID">
                    <ItemTemplate>
                        ...
                        <asp:DropDownList ID="SupplierIDList" runat="server" DataSourceID="SupplierListODS" 
                            DataTextField="CompanyName" DataValueField="SupplierID" SelectedValue='<%# Eval("SupplierID") %>' Enabled="false"></asp:DropDownList>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Category" SortExpression="CategoryID">
                    <ItemTemplate>
                        ...
                        <asp:DropDownList ID="CategoryIDList" runat="server" 
                            DataSourceID="CategoryListODS" DataTextField="CategoryName" 
                            DataValueField="CategoryID" selectedvalue='<%# Eval("CategoryID") %>' Enabled="false">
    ...
    <asp:ObjectDataSource ID="CategoryListODS" runat="server" 
        OldValuesParameterFormatString="original_{0}" SelectMethod="Categories_List" 
        TypeName="NorthwindSystem.BLL.CategoryController">
    </asp:ObjectDataSource>

    <asp:ObjectDataSource ID="SupplierListODS" runat="server" 
        OldValuesParameterFormatString="original_{0}" SelectMethod="Suppliers_List" 
